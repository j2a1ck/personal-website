...
const SocialMediaLinks = [
  {
    ...
    icon: (
      <FontAwesomeIcon icon={faTelegram} className="h-5 w-max lg:h-7 md:h-7" />
    ),
    label: "Telegram",
  },
  {
    ...
    icon: (
      <FontAwesomeIcon icon={faGithub} className="h-5 w-max lg:h-7 md:h-7" />
    ),
    label: "Github",
  },
  {
    ...
    icon: (
      <FontAwesomeIcon icon={faLinkedin} className="h-5 w-max lg:h-7 md:h-7" />
    ),
    label: "Linkedin",
  },
];
